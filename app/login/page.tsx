    ...
    <div className="min-h-screen w-full flex items-center justify-center p-6 bg-brand-50" style={{ background: 'radial-gradient(circle at 50% 0%, #ffffff 0%, #f7f7f0 100%)' }}>
      <div className="w-full max-w-[420px] bg-white border border-[#f0f0e6] rounded-[2rem] p-8 md:p-10 shadow-2xl relative z-10">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h2 className="text-xl font-bold tracking-tight text-[#1e293b]">Vítej zpět</h2>
          <p className="text-[10px] text-[#8b8b43] font-bold uppercase tracking-[0.3em] mt-2">Pokračuj ve svém příběhu</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative group">
              <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#c5c5a1] transition-colors">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between ml-1">
              <label className="text-[10px] font-bold uppercase tracking-widest text-[#305555]/60" htmlFor="password">
                Heslo
              </label>
              <Link href="/forgot-password" title="Obnovit heslo" className="text-[9px] font-bold text-[#8b8b43] hover:text-[#305555]">
                Zapomenuto?
              </Link>
            </div>
            <div className="relative group">
          ...
          <button
            type="submit"
            className="w-full bg-[#030707] text-white py-4 rounded-2xl font-bold text-[11px] uppercase tracking-[0.2em] shadow-xl shadow-black/10 hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 mt-4"
            disabled={loading}
          >
        ...
        <div className="mt-10 pt-8 border-t border-[#f0f0e6] text-center">
          <p className="text-[11px] text-[#64748b] font-bold uppercase tracking-widest">
            Ještě nemáš účet?{" "}
            <Link href="/register" className="text-[#030707] hover:opacity-70 transition-opacity ml-1">
              Založ si ho zdarma
            </Link>
          </p>
        </div>
